...
class _OnboardingState extends State<Onboarding> {
  ...
  Widget build(BuildContext context) {
    final List<String> image = [
      'assets/pizza.png',
      'assets/entregadorpizza.png',
      'assets/mulhercelular.png'
    ];
    final List<String> textBold = [
      'Sua pizza favorita onde sempre deveria estar, na palma da sua mão.',
    ...
    Container carouselText = Container(
      ...
      Text(
        ...
        style:
            TextStyle(color: Color(0xFF868484), fontSize: 15, wordSpacing: 1),
        textAlign: TextAlign.center,
      ),
      SizedBox(
        height: 30,
